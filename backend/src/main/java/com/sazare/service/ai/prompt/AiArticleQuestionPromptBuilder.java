...
public class AiArticleQuestionPromptBuilder {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            直接原创一篇自然中文文章，并为每个中文句子提供语义、人物关系和语气忠实，且符合真实日语习惯的参考译文。
            ...
            japaneseReference 不得按源语言的表面结构逐词翻译；应在不丢失关键信息、不改变说话者和动作归属的前提下，按自然日语重新组织表达。
            日常口语或对话中，主语、话题、已知宾语能从上下文明确推断时，应自然省略；不得把“我/你”或“I/you”机械翻成「わたし」「あなた」。尤其不得默认用「あなた」直接称呼对方，应根据人物关系和语境选择省略、姓名、职务或关系称呼。
            只有省略会造成歧义，或确有对比、强调、确认人物身份等语用需要时，才显式使用人称表达。
            日语参考句不得重复。
