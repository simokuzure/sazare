...
final class GoogleAiReviewSupport {
    ...
    GoogleAiReviewSupport(AiProperties.Google properties, ObjectMapper objectMapper, AiProviderHttpClient httpClient) {
        this.properties = properties;
        this.objectMapper = objectMapper;
        this.httpClient = httpClient;
    }

    String execute(AiQuestionPrompt prompt) {
        validateProperties();
    ...
    private URI buildUri() {
        ...
        return URI.create(baseUrl + "/models/" + URLEncoder.encode(model, StandardCharsets.UTF_8) + ":generateContent");
    }
    ...
    private String buildRequestBody(AiQuestionPrompt prompt) {
        Map<String, Object> body = Map.of(
                ...
                "contents", List.of(Map.of("role", "user", "parts", List.of(Map.of("text", prompt.userPrompt())))),
